...
FORE_CONE_RAD = math.radians(float(WANG2007_SIM_DEFAULTS["coning_angles_deg"]["fore"]))
HIND_CONE_RAD = math.radians(float(WANG2007_SIM_DEFAULTS["coning_angles_deg"]["hind"]))
...
def build_sim_cfg(
    ...
    return f"""# Auto-generated by cases/wang2007/pipeline.py
