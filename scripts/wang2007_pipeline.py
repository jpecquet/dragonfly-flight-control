...
# Wing motion source: separate sinusoid fit per wing
...
def build_sim_cfg_smoothed(
    ...
    return f"""# Auto-generated by scripts/wang2007_pipeline.py
# Source: data/kinematics/wang2007/exp_data.csv
# Wing motion source: Fourier-smoothed experimental data
...
def stage_translate(
    ...
    if motion_source == MOTION_SOURCE_FIT:
        ...
        cfg_text = build_sim_cfg_smoothed(
            mapping,
            n_wingbeats,
            steps_per_wingbeat,
            tether,
