...
- {download}`stroke_fore_left.mp4 <wang2007/artifacts/post/stroke_fore_left.mp4>`
- {download}`kinematics_inputs.light.png <wang2007/artifacts/post/kinematics_inputs.light.png>`
- {download}`kinematics_inputs.dark.png <wang2007/artifacts/post/kinematics_inputs.dark.png>`
- {download}`motion_mapping.light.png <wang2007/artifacts/post/motion_mapping.light.png>`
- {download}`motion_mapping.dark.png <wang2007/artifacts/post/motion_mapping.dark.png>`
- {download}`force_comparison.light.png <wang2007/artifacts/post/force_comparison.light.png>`
- {download}`force_comparison.dark.png <wang2007/artifacts/post/force_comparison.dark.png>`
